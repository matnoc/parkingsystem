...
public class DBConstants {
    ...
    public static final String GET_FIRST_TICKET = "select count(*) as VISIT_NUMBER from ticket t,parking p where t.VEHICLE_REG_NUMBER=? and t.PARKING_NUMBER=p.PARKING_NUMBER and p.Type=?";
}
